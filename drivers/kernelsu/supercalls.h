...
// SUSFS IOCTL commands
#ifdef CONFIG_KSU_SUSFS
#define KSU_IOCTL_SUSFS_ADD_SUS_PATH _IOC(_IOC_WRITE, 'S', 1, 0)
#define KSU_IOCTL_SUSFS_ADD_SUS_PATH_LOOP _IOC(_IOC_WRITE, 'S', 2, 0)
#define KSU_IOCTL_SUSFS_SET_ANDROID_DATA_ROOT_PATH _IOC(_IOC_WRITE, 'S', 3, 0)
#define KSU_IOCTL_SUSFS_SET_SDCARD_ROOT_PATH _IOC(_IOC_WRITE, 'S', 4, 0)
#define KSU_IOCTL_SUSFS_ADD_SUS_MOUNT _IOC(_IOC_WRITE, 'S', 5, 0)
#define KSU_IOCTL_SUSFS_HIDE_SUS_MNTS_FOR_ALL_PROCS _IOC(_IOC_WRITE, 'S', 6, 0)
#define KSU_IOCTL_SUSFS_UMOUNT_FOR_ZYGOTE_ISO_SERVICE _IOC(_IOC_WRITE, 'S', 7, 0)
#define KSU_IOCTL_SUSFS_ADD_SUS_KSTAT _IOC(_IOC_WRITE, 'S', 8, 0)
#define KSU_IOCTL_SUSFS_UPDATE_SUS_KSTAT _IOC(_IOC_WRITE, 'S', 9, 0)
#define KSU_IOCTL_SUSFS_ADD_TRY_UMOUNT _IOC(_IOC_WRITE, 'S', 10, 0)
#define KSU_IOCTL_SUSFS_SET_UNAME _IOC(_IOC_WRITE, 'S', 11, 0)
#define KSU_IOCTL_SUSFS_ENABLE_LOG _IOC(_IOC_WRITE, 'S', 12, 0)
#define KSU_IOCTL_SUSFS_SET_CMDLINE_OR_BOOTCONFIG _IOC(_IOC_WRITE, 'S', 13, 0)
#define KSU_IOCTL_SUSFS_ADD_OPEN_REDIRECT _IOC(_IOC_WRITE, 'S', 14, 0)
#define KSU_IOCTL_SUSFS_SUS_SU _IOC(_IOC_WRITE, 'S', 15, 0)
#define KSU_IOCTL_SUSFS_IS_SUS_SU_READY _IOC(_IOC_READ, 'S', 16, 0)
#define KSU_IOCTL_SUSFS_SHOW_SUS_SU_WORKING_MODE _IOC(_IOC_READ, 'S', 17, 0)
#define KSU_IOCTL_SUSFS_ADD_SUS_MAP _IOC(_IOC_WRITE, 'S', 18, 0)
#define KSU_IOCTL_SUSFS_SHOW_VERSION _IOC(_IOC_READ, 'S', 19, 0)
#define KSU_IOCTL_SUSFS_SHOW_VARIANT _IOC(_IOC_READ, 'S', 20, 0)
#define KSU_IOCTL_SUSFS_SHOW_ENABLED_FEATURES _IOC(_IOC_READ, 'S', 21, 0)
#define KSU_IOCTL_SUSFS_ENABLE_AVC_LOG_SPOOFING _IOC(_IOC_WRITE, 'S', 22, 0)
#endif
